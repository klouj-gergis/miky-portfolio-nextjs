...
export default function About() {
  return (
    <section className="w-full h-[80vh] flex flex-col items-center justify-center px-5 gap-5 text-center">
      ...
      <Link href="/about" className="px-5 py-3 bg-accent rounded-lg text-xl">Let's Work Together</Link>
    </section>
  )
}
