...
export default function HeroSection() {
  return (
    <section className="w-full h-screen flex flex-col items-center justify-center gap-10 overflow-hidden relative">
      ...
      <div className="w-11/12 lg:w-full h-3/6 lg:h-full flex justify-center lg:justify-start lg:absolute lg:top-0 lg:left-0 border-3 lg:border-none rounded-2xl overflow-hidden shadow-lg shadow-blue-500/50 lg:shadow-none">
